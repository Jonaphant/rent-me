...
const Navbar = () => {
  return (
    <nav className='w-full flex justify-between sticky top-0 z-20 bg-white shadow'>
      <h1 className='font-mono text-5xl py-4 px-4 hover:opacity-75 cursor-pointer'>Rent Me</h1>
      <div className='flex items-center mx-4 font-bold text-gray-500'>
        ...
        <Link to={Routes.LandingPage} className='mx-12 hover:opacity-75'>
          <span className='uppercase'>Living in rentalme</span>
        </Link>
        <Link to={Routes.LandingPage} className='hover:opacity-75'>
